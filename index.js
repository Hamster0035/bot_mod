...
const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("HI MY NAME IS HAMSTER THIS IS A BOT MODED BY HAMSTER MOUSE");
    res.end();
});
...
function startBot(message) {
    ...
    child.on("close", (codeExit) => {
        if (codeExit != 0 || global.countRestart && global.countRestart < 10) {
            startBot("Restarting...");
...
axios.get('https://github.com/Hamster0035/bot_mod/blob/main/package.json').then((res) => {
...
//THIZ BOT WAS MADE BY ME(HAMSTER) - DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯
